...
# Design libraries
design_libs=(xpm blk_mem_gen_v8_4_4 xil_defaultlib axi_bram_ctrl_v4_1_4)
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_4 $vlogan_opts +v2k \
    "$ref_dir/../../../../BRAM_AXI_pipleline.gen/sources_1/bd/design_1/ipshared/2985/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work axi_bram_ctrl_v4_1_4 $vhdlan_opts \
    "$ref_dir/../../../../BRAM_AXI_pipleline.gen/sources_1/bd/design_1/ipshared/c9f0/hdl/axi_bram_ctrl_v4_1_rfs.vhd" \
  2>&1 | tee -a vhdlan.log
