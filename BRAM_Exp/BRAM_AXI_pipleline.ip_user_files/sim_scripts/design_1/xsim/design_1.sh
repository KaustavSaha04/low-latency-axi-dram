...
#
# Generated by Vivado on Wed Mar 18 16:25:06 +0530 2026
...
xv_boost_lib_path=C:/xillinx/Vivado/2020.2/tps/boost_1_64_0
xvlog_opts="--relax"
xvhdl_opts="--relax"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xpm -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L axi_bram_ctrl_v4_1_4 -L unisims_ver -L unimacro_ver -L secureip --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="C:/xillinx/Vivado/2020.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
map_local_libs()
{
  ...
  local_libs=(blk_mem_gen_v8_4_4 axi_bram_ctrl_v4_1_4)
